...
\begin{abstract}
El presente informe tiene como objetivo la documentación de la etapa de estudio del estado del arte y pruebas de concepto sobre analíticas de audio en tiempo real para seguridad urbana, realizada en SONDA Uruguay en el período de Diciembre 2015 a Marzo 2016 para su aprobación en créditos de la Maestría en Ingeniería Eléctrica de la UdelaR. Se detalla sobre los algoritmos implementados en ambiente de laboratorio, para prueba de concepto de dos analíticas en particular: Detección de Niveles Predefinidos de Sonido y Detección de Sirenas. 
\end{abstract}
...
\subsection{Sobre el software de analíticas para seguridad urbana}                            
El software de analíticas actualmente forma parte de la tecnología implantada en el Centro de Monitoreo (CM) del Ministerio del Interior, en el proyecto Ciudad Segura. Tiene como objetivo apoyar la operativa de los visualizadores del CM, alertando automáticamente frente a eventos de interés predefinidos, mediante el procesamiento de señales en tiempo real.  

\bigskip
En lo que sigue se detallará sobre los algoritmos implementados para la prueba de concepto de procesamiento de audio en tiempo real, para funcionamiento embebido en dicho software. Sin embargo, no tiene como objetivo este documento, especificar puntos particulares que atenten contra la privacidad de la empresa y del producto comercial. 
